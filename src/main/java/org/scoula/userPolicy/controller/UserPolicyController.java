...
public class UserPolicyController {
     ...
     */
    @ApiOperation(value = "유저 정책 조건 생성", notes = "새로운 유저 정책 조건을 생성하는 API")
    @ApiResponses(value = {
...
//        UserPolicyDTO createdPolicy = userPolicyService.saveUserPolicy(username, userPolicyDTO); // Assuming the service returns the created policy
